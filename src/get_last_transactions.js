...
async function task() {
    ...
    const nbtc = tools.getLastTransactions(vbtc, "BTC", btc_ts);
    const neth = tools.getLastTransactions(veth, "ETH", eth_ts);
    const nxtz = tools.getLastTransactions(vxtz, "XTZ", xtz_ts);
