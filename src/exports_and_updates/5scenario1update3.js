...
////////////////////// DB ////////////////////////////////
 ...
 async function updateSMAKamounts(co, addresses) {
    const get_amount_usd = 'SELECT sum(b.amount*b.price_dollar) FROM dxd_transactions t INNER JOIN dxd_blockchain b ON b.tx_hash = t.tx_hash WHERE t.sender_addr = ?';
